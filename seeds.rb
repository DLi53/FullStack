...
comment2 = Comment.create!({description: 'woawies', commenter_id: user2.id, image_id: image_w1.id})
comment2 = Comment.create!({description: 'sheesh', commenter_id: user2.id, image_id: image_w1.id})
